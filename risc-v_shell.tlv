...
\TLV
   ...
   *failed = *cyc_cnt > M4_MAX_CYC;
   ...
   m4+rf(32, 32, $reset, ($rd == 0 ? 0 : $rd_valid), $rd, ($is_load ? $ld_data : $result), $rs1_valid, $rs1, $src1_value, $rs2_valid, $rs2, $src2_value)
   m4+dmem(32, 32, $reset, $result[9:5], $is_s_instr, $src2_value[31:0], $is_load, $ld_data)
   m4+cpu_viz()
\SV
   endmodule